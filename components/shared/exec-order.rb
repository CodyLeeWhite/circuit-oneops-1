...
puts "FINDSTRING File.exists?('/opt/oneops/inductor/lib/exec-gems-cache/exec-order'): #{File.exists?('/opt/oneops/inductor/lib/exec-gems-cache/exec-order')}"
puts "FINDSTRING File.expand_path(File.dirname(__FILE__)): #{File.expand_path(File.dirname(__FILE__))}"
if File.exists?('/opt/oneops/inductor/lib/exec-gems-cache/exec-order')
  if !File.symlink?("#{File.expand_path(File.dirname(__FILE__))}/exec-order")
    File.symlink("/opt/oneops/inductor/lib/exec-gems-cache/exec-order","#{File.expand_path(File.dirname(__FILE__))}/exec-order")
  end
end
